...
<div>
    ...
    <!--  Hero area End -->
    <!-- Blog Area Start -->
    <form class="mb-3" name="myform" action="/reviewUpdate" id="myform" method="post" novalidate="novalidate"
        ...
        <div style="text-align: center">
            <div class="comment-form">
                ...
                <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="orderId" value="${reviewDetail.orderId}"/>
                                     ...
                                     <div class="col-sm-6" style="text-align: left; margin-left: 550px;" >
                                         <br/>
                                                                                                        <fieldset >
                                        ...
                                        <input class="form-control" name="bookName"  type="text" placeholder="제목"
                                               value="도서제목: ${reviewDetail.bookName}"  readonly style="width : 500px; height : 40px; margin-left: 539px;" >

                                        <input class="form-control" name="reviewSubject" id="reviewSubject" type="text" placeholder="제목"
                                         value="${reviewDetail.reviewSubject}"  style="width : 500px; height : 40px; margin-left: 539px;" >
                    ...
                    <div class="form-group">
                        <button type="submit" id="update" class="button button-contactForm btn_1 boxed-btn">수정하기</button>
                    </div>
                </div>
                <%--                        </form>--%>
            </div>
